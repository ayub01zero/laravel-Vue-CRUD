<template>
    <form @submit.prevent="submitLogin">
        ...
        <div>
            ...
            <input v-model="loginForm.email" id="email" type="email" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"  autofocus autocomplete="username">
            <!-- Validation Errors -->
        ...
        <div class="mt-4">
            ...
            <input v-model="loginForm.password" id="password" type="password" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"  autocomplete="current-password">
            <!-- Validation Errors -->
            <div class="text-red-600 mt-1">
        ...
        <div class="flex items-center justify-end mt-4">
            <a href="http://127.0.0.1:8000/auth/redirect" 
               target="_self" 
